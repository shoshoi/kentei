 ...
 * 実施団体情報削除機能.
 * <ul>
 * <li>実施団体メンテナンス画面(mg_mainteassocimaster)からPOSTされた情報をもとに該当する実施団体情報を削除する
...
public class Mg_MainteAssocimaster_delete extends HttpServlet{
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)
		...
		String associSQL = "delete from association where associ_no = ?";	//実施団体情報削除
